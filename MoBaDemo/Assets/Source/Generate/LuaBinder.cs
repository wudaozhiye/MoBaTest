...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.BeginModule("ObservableSupport");
		L.RegFunction("PropertyChangingEventHandler", Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler);
		L.RegFunction("AddingNewEventHandler", Newtonsoft_Json_ObservableSupport_AddingNewEventHandler);
		L.EndModule();
		L.EndModule();
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Newtonsoft_Json_ObservableSupport_AddingNewEventHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<Newtonsoft.Json.ObservableSupport.AddingNewEventHandler>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<Newtonsoft.Json.ObservableSupport.AddingNewEventHandler>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
