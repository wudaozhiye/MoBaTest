...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler), factory.Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler);
		dict.Add(typeof(System.ComponentModel.ListChangedEventHandler), factory.System_ComponentModel_ListChangedEventHandler);
		dict.Add(typeof(Newtonsoft.Json.ObservableSupport.AddingNewEventHandler), factory.Newtonsoft_Json_ObservableSupport_AddingNewEventHandler);
		...
		DelegateTraits<Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler>.Init(factory.Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler);
		DelegateTraits<System.ComponentModel.ListChangedEventHandler>.Init(factory.System_ComponentModel_ListChangedEventHandler);
		DelegateTraits<Newtonsoft.Json.ObservableSupport.AddingNewEventHandler>.Init(factory.Newtonsoft_Json_ObservableSupport_AddingNewEventHandler);
		...
		TypeTraits<Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler>.Init(factory.Check_Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler);
		...
		TypeTraits<Newtonsoft.Json.ObservableSupport.AddingNewEventHandler>.Init(factory.Check_Newtonsoft_Json_ObservableSupport_AddingNewEventHandler);
		...
		StackTraits<Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler>.Push = factory.Push_Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler;
		...
		StackTraits<Newtonsoft.Json.ObservableSupport.AddingNewEventHandler>.Push = factory.Push_Newtonsoft_Json_ObservableSupport_AddingNewEventHandler;
	...
	class Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event : LuaDelegate
	{
		public Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event(LuaFunction func) : base(func) { }
		public Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(object param0, Newtonsoft.Json.ObservableSupport.PropertyChangingEventArgs param1)
		{
			func.BeginPCall();
			func.Push(param0);
			func.PushObject(param1);
		...
		public void CallWithSelf(object param0, Newtonsoft.Json.ObservableSupport.PropertyChangingEventArgs param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler fn = delegate(object param0, Newtonsoft.Json.ObservableSupport.PropertyChangingEventArgs param1) { };
			return fn;
		}

		if(!flag)
		{
			Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event target = new Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event(func);
			Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event target = new Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler_Event(func, self);
			Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler), L, pos);
	}

	void Push_Newtonsoft_Json_ObservableSupport_PropertyChangingEventHandler(IntPtr L, Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler o)
	{
		ToLua.Push(L, o);
	}
	...
	class Newtonsoft_Json_ObservableSupport_AddingNewEventHandler_Event : LuaDelegate
	{
		public Newtonsoft_Json_ObservableSupport_AddingNewEventHandler_Event(LuaFunction func) : base(func) { }
		public Newtonsoft_Json_ObservableSupport_AddingNewEventHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(object param0, Newtonsoft.Json.ObservableSupport.AddingNewEventArgs param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	bool Check_Newtonsoft_Json_ObservableSupport_AddingNewEventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Newtonsoft.Json.ObservableSupport.AddingNewEventHandler), L, pos);
	}
