...
public class Newtonsoft_Json_Linq_JObjectWrap
{
	...
	{
		ToLua.Push(L, new EventObject(typeof(Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler)));
		return 1;
	}
	...
	static int set_PropertyChanging(IntPtr L)
	{
		try
		{
			...
			if (arg0.op == EventOp.Add)
			{
				Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler ev = (Newtonsoft.Json.ObservableSupport.PropertyChangingEventHandler)arg0.func;
